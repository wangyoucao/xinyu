/**
 * handle gif image , split a gif into frames
 * @author zhangjie
 * @version 1.0
 * @since 2012-2-13
 * */
...
public class GifHelper {
	...
	/**
	 * get bitmap in index n
	 * 
	 * @param n
	 *            index
	 * @return get the n_th bitmap
	 * **/
	...
	/**
	 * tell whether the input is a gif or not
	 * 
	 * @param is
	 *            input stream
	 * @return true if it is a gif otherwise false
	 * */
	...
	protected void readImage() {
		...
		// System.out.println("hen delay" +delay);
