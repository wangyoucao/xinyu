...
import together.connectivity.OnViewChangeListener;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			if (velocityX > SNAP_VELOCITY && mCurScreen > 0) {
				...
				// Intent intent = new
				// Intent(CarModeHintActivity.this,MusicActivity.class);
				// CarModeHintActivity.this.startActivity(intent);
