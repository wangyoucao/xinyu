...
public class ReplyTextImageView extends ImageView{
	...
	public ReplyTextImageView(Context context, AttributeSet set)
	  {
	  ...
	  public ReplyTextImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
	  {
    ...
    public void setFont(together.activity.ReplyWcreatewhActivity.WFont wcentury) {
		switch (wcentury.ordinal()) {
		default:
		case 0:
